...
#
# 用途：kb-kit 现在支持 OpenClaw / Hermes / DSH / Codex 四种 agent。
...
#   json    : 记忆是纯 JSON（DSH 的 agent-memory）
#   sqlite  : 记忆是 SQLite 数据库（Codex）
AGENT_TYPES = ("md", "json", "sqlite")
